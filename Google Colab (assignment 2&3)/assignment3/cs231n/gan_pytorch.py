...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss_real = bce_loss(logits_real,real)
    loss_fake = bce_loss(logits_fake,fake)
...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss_real = ((scores_real-1)**2).mean()*0.5
    loss_fake = (scores_fake**2).mean()*0.5
...
def ls_generator_loss(scores_fake):
    ...
    fake = torch.ones_like(scores_fake)
    loss = (bce_loss(scores_fake,fake).mean()**2)*0.5
